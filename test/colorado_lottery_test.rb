...
class ColoradoLotteryTest < Minitest::Test
  ...
  def test_it_has_eligible_contestants
    ...
    assert @lottery.eligible_contestants(@cash_5).include?(@grace)
    assert @lottery.eligible_contestants(@cash_5).include?(@winston)
  ...
  def test_it_can_charge_contestants
    ...
    assert_equal 20, @grace.spending_money
    ...
    assert_equal 20, @frederick.spending_money
  ...
  def test_it_can_draw_winners
    ...
    # date = Date.today
    # date.stubs(:today).returns("2020-04-07")
    assert_equal "2021-02-23", @lottery.draw_winners
  end
end